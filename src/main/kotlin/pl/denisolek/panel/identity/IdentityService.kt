...
class IdentityService(
    ...
    fun setPassword(setPasswordDTO: SetPasswordDTO) {
        val user = userService.findByUsername(setPasswordDTO.username) ?: throw ServiceException(
        ...
        when {
            user.activationKey == setPasswordDTO.activationKey -> {
                ...
                "Activation key doesn't match or password is already set."
            )
        }
    }
