...
class PanelReservationService(
    ...
    private fun prepareReservationCustomer(
        createReservationDTO: PanelCreateReservationDTO,
        restaurant: Restaurant
    ): Customer {
        ...
        return customerService.findOrCreate(
    ...
    fun cancelReservation(restaurant: Restaurant, reservation: Reservation): PanelReservationsDTO {
        ...
        return PanelReservationsDTO.createPanelReservationDTO(
            updatedRestaurant,
    ...
    fun getSpotReservations(restaurant: Restaurant, spot: Spot, date: LocalDate): SpotReservationsDTO {
        ...
        return SpotReservationsDTO.fromSpotDateReservations(
            ...
            reservations = restaurant.reservations.filter {
                it.startDateTime.toLocalDate() == date && it.spots.contains(
                    spot
                )
            }
        )
